...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
    ...
    return(
        <Dialog.Root>
            <Dialog.Trigger className='flex flex-col text-left rounded-md bg-slate-700 p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600 transition-all focus-visible:ring-2 focus-visible:ring-lime-600 focus:ring-2 focus:ring-lime-400'>
                    ...
                    <form onSubmit={handleSaveNote} className='flex-1 flex flex-col'>                        
                        ...
                        {isRecording ? (
                            <button 
                                ...
                                className='flex flex-row items-center justify-center w-full bg-slate-900 text-center text-sm text-slate-300 outline-none font-medium hover:text-slate-100 transition-colors'
                            >
                                <Dot className='text-red-500 animate-pulse w-14 h-14' /> Gravando! (clique p/ interromper)
                            </button>
                        ) : (
                            <button 
                                type='button'
