...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
    return(
        <Dialog.Root>
            <Dialog.Trigger
                className='rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 transition-all focus-visible:ring-2 focus-visible:ring-lime-600 focus:ring-2 focus:ring-lime-400'
            >
